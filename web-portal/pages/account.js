						...
						<Item>
							...
							>
								...
								<p>
									...
									{userData.createdOn.toDate().toLocaleString()}
								</p>
							</div>
							<div
								style={{
					...
					<Grid xs={12} sm={6}>
						<Item>
							...
							>
								...
								>
									<Tooltip title="Set Hospital Domain for adding staff & admins">
										<TextField
											id="outlined-basic"
											label="Hospital Domain"
											variant="outlined"
											placeholder={userData.domain}
											value={domain}
											onChange={(e) => {
									...
									<Button startIcon={<AddLocationIcon />} onClick={location}>
										Update location
									</Button>
								</div>
							</div>
