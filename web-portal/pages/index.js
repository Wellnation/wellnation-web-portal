...
const Landing = () => {
  ...
  const otherfeatures = otherFeatures.map((feature, index) => <Feature {...feature} key={index} />)
          ...
          <div className={classes.inner}>
            <div className={classes.content}>
              <Title className={classes.title}>
                <span className={classes.ofeathighlight}>Healthier</span> you, happier{" "}
                <span className={classes.highlight}>world</span>.
              </Title>
              <Text color="dimmed" mt="md">
                Revolutionizing healthcare with real-time data and transparent information. Discover nearby hospitals,
                book appointments, and access vital medical services through our intuitive apps and web portal.
                Experience the future of immediate healthcare support with WellBot and our emergency SOS Alert system.
                Join us today and transform your healthcare journey.
              </Text>

              <List mt={30} spacing="sm" size="sm" icon={<CheckCircle sx={{ color: "#6559fe" }} />}>
                <List.Item>
                  <b>Public User App</b> - Find nearby hospitals, book appointments, access real-time information on
                  doctors and tests.
                </List.Item>
                <List.Item>
                  <b>Web Portal for Hospitals</b> - Streamline appointment scheduling, manage patient data, and
                  collaborate with doctors and service providers.
                </List.Item>
                <List.Item>
                  <b>Web Portal for Doctors</b> - Access patient records, review appointments, and communicate with
                  hospitals and colleagues for personalized care.
                </List.Item>
                <List.Item>
                  <b>Ambulance Driver App</b> - Enhance communication and coordination for efficient patient
      ...
      <section id="features">
        <Container size="lg" py="xl">
          ...
          <Text c="dimmed" className={classes.featDescription} ta="center" mt="md">
            Empowering Healthcare: Seamless Booking, Real-time Data, Rapid Response
          </Text>
        ...
        <Container className={classes.ofeatwrapper}>
          <Title className={classes.ofeattitle}>
            Enriching Healthcare system <span className={classes.ofeathighlight}>for All</span>.
          </Title>

          <Container size={560} p={0}>
            <Text size="sm" className={classes.ofeatdescription}>
              Bridging the Gap: WellNation revolutionizes healthcare for all stakeholders, connecting users, hospitals,
              doctors, and service providers through seamless technology.
            </Text>
          </Container>
